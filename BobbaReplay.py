...
source = [Dyn_MFA_System.ProcessList[0].ID, Dyn_MFA_System.ProcessList[0].ID, Dyn_MFA_System.ProcessList[0].ID,
          Dyn_MFA_System.ProcessList[1].ID, Dyn_MFA_System.ProcessList[1].ID, Dyn_MFA_System.ProcessList[1].ID,
          Dyn_MFA_System.ProcessList[2].ID, Dyn_MFA_System.ProcessList[2].ID, Dyn_MFA_System.ProcessList[2].ID,
          Dyn_MFA_System.ProcessList[2].ID, Dyn_MFA_System.ProcessList[6].ID, Dyn_MFA_System.ProcessList[7].ID,
          Dyn_MFA_System.ProcessList[7].ID, Dyn_MFA_System.ProcessList[8].ID, Dyn_MFA_System.ProcessList[6].ID]

target = [Dyn_MFA_System.ProcessList[1].ID, Dyn_MFA_System.ProcessList[2].ID, Dyn_MFA_System.ProcessList[3].ID,
          Dyn_MFA_System.ProcessList[5].ID, Dyn_MFA_System.ProcessList[7].ID, Dyn_MFA_System.ProcessList[9].ID,
          Dyn_MFA_System.ProcessList[4].ID, Dyn_MFA_System.ProcessList[6].ID, Dyn_MFA_System.ProcessList[7].ID,
          Dyn_MFA_System.ProcessList[9].ID, Dyn_MFA_System.ProcessList[7].ID, Dyn_MFA_System.ProcessList[9].ID,
          Dyn_MFA_System.ProcessList[8].ID, Dyn_MFA_System.ProcessList[9].ID, Dyn_MFA_System.ProcessList[0].ID]
timesee = 2029
timecheck = timesee - 2005
value = [Dyn_MFA_System.FlowDict['F_0_1'].Values[timecheck], Dyn_MFA_System.FlowDict['F_0_2'].Values[timecheck],
         Dyn_MFA_System.FlowDict['F_0_3'].Values[timecheck], Dyn_MFA_System.FlowDict['F_1_5'].Values[timecheck],
         Dyn_MFA_System.FlowDict['F_1_7'].Values[timecheck], Dyn_MFA_System.FlowDict['F_1_9'].Values[timecheck],
         Dyn_MFA_System.FlowDict['F_2_4'].Values[timecheck], Dyn_MFA_System.FlowDict['F_2_6'].Values[timecheck],
         Dyn_MFA_System.FlowDict['F_2_7'].Values[timecheck], Dyn_MFA_System.FlowDict['F_2_9'].Values[timecheck],
         Dyn_MFA_System.FlowDict['F_6_7'].Values[timecheck], Dyn_MFA_System.FlowDict['F_7_9'].Values[timecheck],
         Dyn_MFA_System.FlowDict['F_7_8'].Values[timecheck], Dyn_MFA_System.FlowDict['F_8_9'].Values[timecheck],
         Dyn_MFA_System.FlowDict['F_6_0'].Values[timecheck]]
# print(Dyn_MFA_System.FlowDict['F_0_1'].Values + Dyn_MFA_System.FlowDict['F_0_2'].Values + Dyn_MFA_System.FlowDict[
#     'F_0_3'].Values)
color_link = ['#b0ffde', '#b0ffde', '#d1d1d1',
...
fig1 = go.Figure(data)
# fig1.update_layout(hovermode='x', title='Used LIBs Flow', font=dict(size=24, color='white'), paper_bgcolor='#3b3737')
fig1.show()
